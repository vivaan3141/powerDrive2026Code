...
vex::motor LB(vex::PORT1, vex::gearSetting::ratio18_1, false); //Left Back Motor
vex::motor LM(vex::PORT2, vex::gearSetting::ratio18_1, false); //Left Middle Motor
vex::motor LF(vex::PORT3, vex::gearSetting::ratio18_1, false); //Left Front Motor
vex::motor RB(vex::PORT4, vex::gearSetting::ratio18_1, true); //Right Back Motor
vex::motor RM(vex::PORT5, vex::gearSetting::ratio18_1, true); //Right Middle Motor
vex::motor RF(vex::PORT6, vex::gearSetting::ratio18_1, true); //Right Front Motor
...
vex::motor Arm1(vex::PORT7, vex::gearSetting::ratio18_1, true); //Arm motor
vex::motor Arm2(vex::PORT8, vex::gearSetting::ratio18_1, true); //Arm motor
